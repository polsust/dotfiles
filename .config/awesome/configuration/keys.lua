...
awful.keyboard.append_global_keybindings({
  ...
  awful.key({ mod }, "d", function()
    awful.spawn.with_shell(apps.default.script_launcher)
  end, { description = "open script launcher", group = "app" }),
  ...
  awful.key({ mod }, "v", function()
    awful.spawn.with_shell(apps.default.clipboard_manager)
  end, { description = "open clipboard manager", group = "app" }),

  --- Emoji selector
  awful.key({ mod }, ".", function()
    awful.spawn.with_shell(apps.default.emoji_selector)
  end, { description = "open emoji selector", group = "app" }),
  ...
  end, { description = "open terminal file manager", group = "app" }),
  ...
  awful.key({ mod, shift }, "p", function()
    awful.spawn(apps.default.audio_mixer)
  end, { description = "open audio mixer", group = "app" }),

  --- Bluetooth manager
  awful.key({ mod, shift }, "b", function()
    awful.spawn(apps.default.bluetooth_manager)
  end, { description = "open bluetooth manager", group = "app" }),
...
client.connect_signal("request::default_keybindings", function()
  awful.keyboard.append_client_keybindings({
    ...
    awful.key({ mod }, "Tab", function()
      awful.spawn.with_shell(apps.default.window_finder)
    end),
  })
end)
...
awful.keyboard.append_global_keybindings({
  ...
  -- end, { description = "toggle central panel", group = "panel" }),
})
