...
local user_scripts = "/home/polsust/.scripts/"
...
local function autostart_apps()
  ...
  --- User
  helpers.run.run_once_grep("honeygain")
  helpers.run.run_once_grep("clipmenu")
  -- helpers.run.run_once_grep("discord")
  helpers.run.run_once_grep("firefox")

  helpers.run.run_once_grep(user_scripts .. "setupMonitors")
  helpers.run.run_once_grep("clipmenud")
