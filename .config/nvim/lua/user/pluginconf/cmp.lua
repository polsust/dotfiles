...
cmp.setup({
  ...
  formatting = {
    ...
    format = function(entry, vim_item)
      -- Kind icons
      vim_item.kind = string.format("%s %s", vscode_kinds[vim_item.kind], vim_item.kind) -- This concatonates the icons with the name of the item kind
      -- Source
      vim_item.menu = ({
        luasnip = "[Snippet]",
        nvim_lsp = "[LSP]",
...
-- TODO: Fix this to make it work without removing regular vim autocomplete
